...
void Display_Text()
{
	...
	ILI9341_Draw_String(20, 60, WHITE, BLACK, "This is the test for STM32 F407!", 2);

	ILI9341_Draw_String(20, 80, WHITE, BLACK, "AND TFT LCD Display SPI", 2);

	ILI9341_Draw_String(20, 100, WHITE, BLACK, " ... GlobalLogic Education ...  ", 2);
