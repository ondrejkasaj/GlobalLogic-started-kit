...
/* custom definitions for TOUCH PINS...  */


//#define PEN  		PBin(1)  	//T_PEN
#define T_IRQ		GPIO_ReadInputDataBit(T_IRQ_GPIO_Port, T_IRQ_Pin)

//#define T_DO_ON		GPIO_SetBits(T_DO_GPIO_Port, T_DO_Pin)
//#define T_DO_OFF	GPIO_ResetBits(T_DO_GPIO_Port, T_DO_Pin)
#define T_DO		GPIO_ReadInputDataBit(T_DO_GPIO_Port, T_DO_Pin)

//#define T_DIN 	PFout(11)  	//T_MOSI
#define T_DIN_ON	GPIO_SetBits(T_DIN_GPIO_Port, T_DIN_Pin)
#define T_DIN_OFF	GPIO_ResetBits(T_DIN_GPIO_Port, T_DIN_Pin)

//#define T_CLK 	PBout(0)  	//T_SCK
#define T_CLK_ON	GPIO_SetBits(T_CLK_GPIO_Port, T_CLK_Pin)
#define T_CLK_OFF	GPIO_ResetBits(T_CLK_GPIO_Port, T_CLK_Pin)

//#define TCS  		PCout(5)  	//T_CS
#define T_CS_ON		GPIO_SetBits(T_CS_GPIO_Port, T_CS_Pin)
#define T_CS_OFF	GPIO_ResetBits(T_CS_GPIO_Port, T_CS_Pin)
...
void TM_ILI9341_Init() {
	...
	/* THESE ARE CUSTOM GPIO INITS FOR PINS ON TOUCH SCREEN ... */

	/* Init IRQ PIN on TOUCH */
	TM_GPIO_Init(T_IRQ_GPIO_Port, T_IRQ_Pin, TM_GPIO_Mode_IN, TM_GPIO_OType_PP, TM_GPIO_PuPd_NOPULL, TM_GPIO_Speed_Low);

	/* Init T_DO PIN on TOUCH */
	TM_GPIO_Init(T_DO_GPIO_Port, T_DO_Pin, TM_GPIO_Mode_IN, TM_GPIO_OType_PP, TM_GPIO_PuPd_NOPULL, TM_GPIO_Speed_Low);

	/* Init T_DI PIN on TOUCH */
	TM_GPIO_Init(T_DIN_GPIO_Port, T_DIN_Pin, TM_GPIO_Mode_OUT, TM_GPIO_OType_PP, TM_GPIO_PuPd_NOPULL, TM_GPIO_Speed_Low);

	/* Init T_CLK PIN on TOUCH */
	TM_GPIO_Init(T_CLK_GPIO_Port, T_CLK_Pin, TM_GPIO_Mode_OUT, TM_GPIO_OType_PP, TM_GPIO_PuPd_NOPULL, TM_GPIO_Speed_Low);

	/* Init T_CS PIN on TOUCH */
	TM_GPIO_Init(T_CS_GPIO_Port, T_CS_Pin, TM_GPIO_Mode_OUT, TM_GPIO_OType_PP, TM_GPIO_PuPd_NOPULL, TM_GPIO_Speed_Low);
